...
(* OASIS_START *)
(* DO NOT EDIT (digest: deed26b09e091f77af7e9f97562b7326) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cryptokit",
                               Some (OASISVersion.VGreaterEqual "1.5"));
                           FindlibPackage ("erm_tls", None)
                        ];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "erm_xmpp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "S~ZH¡\027¬a¤h\021‡>\001K\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
